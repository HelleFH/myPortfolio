...
import ContactUsButton from '../contact-us';  // Make sure this is the right path to your button
import './hero.scss';
    ...
    <div className="hero__button-container">
      {buttons && buttons.map((button, index) => (
        <React.Fragment key={index}>
          ...
          {button.type === 'modal' && button.text && (
            <ContactUsButton openModal={openModal} buttonLabel={button.text} />
          )}
        </React.Fragment>
      ))}
