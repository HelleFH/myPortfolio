  ...
  export const frontendProjects = [
    {
      ...
      description:
        "This is a React-based static website for a company...",
    ...
    },
    {
      ...
      description:
        "React snippets with a navbar, lightbox gallery, a download button and Tinder-like swipe cards...",
    ...
    },
    {
      ...
      description:
        "A dynamic React portfolio page showcasing a visually appealing image grid with a sleek overlay...",
      technologiesMore: [
        "React",
        "Bootstrap",
        "Styled Components",
    ...
    },
    {
      ...
      description:
        "This project is a frontend for a tinder-like dating app developed using React...",
      technologiesMore: [
        "React",
        "Axios",
        "Bootstrap",
    ...
    },
    {
      ...
      description:
        "A news website for Copenhagen, built with vanilla JavaScript...",
      technologiesMore: ["JavaScript"]
    },
    {
      id: 7,
      ...
      description:
        "Netflix Clone is a web application that replicates the user interface and functionalities of Netflix...",
      technologiesMore: ["JavaScript"]
    },
    {
      id: 8,
      ...
      description:
        "A simple site that showcases an interactive image gallery using JQuery showing AI images of dinosaurs...",
    ...
    },
    {
      ...
      description:
        "CSS and HTML for a webshop. It showcases a basic online shop layout with product listings...",
